...
const routes: Routes = [
  { path: '', pathMatch: 'full', redirectTo: 'general' },
  {
    path: 'general',
    loadChildren: () =>
      import('./components/general-setting/general-setting.module').then(
  ...
  { path: 'status', component: StatusSettingComponent },
  {
    path: 'move-size',
    loadChildren: () =>
      import('./components/move-size-setting/move-size-setting.module').then(
        (m) => m.MoveSizeSettingModule
      ),
  },
  ...
  { path: 'truck', component: TruckSettingComponent },
  {
    path: 'users',
    loadChildren: () =>
      import('./components/department-setting/department-setting.module').then(
